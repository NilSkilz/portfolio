                ...
                <div className="row">
                    <div className="col-md-6">
                        <a href="https://www.envato.com" target="_blank" rel="noreferrer">
                            <span className="copy">&copy; Copyright 2023 - Rob Stokes at Aperture Labs</span>
                        </a>
                    </div>
                    <div className="col-md-6">
                        <div className="social-icons">
                            <a href="https://www.facebook.com/rob.limeninja" rel="noreferrer" target="_blank"><i className="fa fa-facebook"></i></a>
                            {/* <a href="https://twitter.com" rel="noreferrer"><i className="fa fa-twitter"></i></a> */}
                            <a href="https://www.linkedin.com/in/rbstokes/  " rel="noreferrer" target="_blank"><i className="fa fa-linkedin"></i></a>
